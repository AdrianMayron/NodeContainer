Run a Docker container with a well-defined tool/runtime stack and its prerequisites. 
Try with **[GitHub Codespaces](https://github.com/features/codespaces)** or **[Visual Studio Code Remote - Containers](https://aka.ms/vscode-remote/containers)**.

others [vscode-remote-try-*](https://github.com/search?q=org%3Amicrosoft+vscode-remote-try-&type=Repositories) sample projects, too.
...
Steps to open this sample in a container using the VS Code
